    ...
    <body>
        ...
        <script>
            ...
            function geocodeAddress(){
                var url = "https://maps.googleapis.com/maps/api/geocode/json?address="+document.getElementById("address").value+"&key=AIzaSyBOnCixHmrgoNlHr5t16-HJWrdaL-mB_W4";
//                window.open(url);
                // url = our json url which hae query or our key 
                // data = this variable contain json output.
                $.getJSON(url, function(data){
                    if(data.status == "OK"){
                        ...
                        // for selecting particular object attribute we have to use $each selector on json(data = json file).
                        ...
                        // ab hum bar bar search karenge toh hmko pehle wale marker hatane honge toh unko ase hataye.
                        if(marker != undefined){
                            marker.setMap(null);   
                        }
                        //create marker
