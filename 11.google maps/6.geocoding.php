    ...
    <body>
        ...
        <script>
            ...
            function geocodeAddress(){
                // {'address': document.getElementById("address").value} = taking user input 
                //function(results, status)= result contain user quer result, and status have staus of result either ok or error.
