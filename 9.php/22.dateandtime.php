...
<!-- Date function take two parameter , jaruri nahi ki aap 2 parameter pass hi karo bt woh parameter time hai agar apni date time banani ho toh woh usliye use aata hai,woh "time()" function leta hai as a parameter, time() function time display ke liye bhi use hota hai.-->
<?php
...
<?php
                // yeh unix format mai time print karta hai.
$timestamp = time();
...
<?php
// aaaj se 1000 din bad ki date kya haiwoh batayega yeh function.    
// humne date mai 1000 add kar diya ab timestamp usi according banega, then function mai timestamp ko call krlenge.                
