...
$myUsername = filter_var($myUsername, FILTER_SANITIZE_STRING);// yeh hackers kuch bhi daal na paye input mai islye yeh function lagaya .
echo $myUsername;
//email example
$myEmail = 'sam@     completeweb   developm\\\\ entcour    se.co.uk';
$myEmail = filter_var($myEmail, FILTER_SANITIZE_EMAIL);//email mai se faltu ki chije hatayega jese \\\ or blank space etc.
echo "<br />" . $myEmail;
//URL example
